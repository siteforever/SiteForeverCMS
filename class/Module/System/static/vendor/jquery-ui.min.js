jquery-ui.js:7839: WARNING - Parse error. Non-JSDoc comment has annotations. Did you mean to start it with '/**'?

^

jquery-ui.js:7848: WARNING - Parse error. Non-JSDoc comment has annotations. Did you mean to start it with '/**'?

^

jquery-ui.js:7995: WARNING - Parse error. Non-JSDoc comment has annotations. Did you mean to start it with '/**'?

^

jquery-ui.js:8047: WARNING - Parse error. Non-JSDoc comment has annotations. Did you mean to start it with '/**'?

^

jquery-ui.js:8074: WARNING - Parse error. Non-JSDoc comment has annotations. Did you mean to start it with '/**'?

^

jquery-ui.js:8102: WARNING - Parse error. Non-JSDoc comment has annotations. Did you mean to start it with '/**'?

^

jquery-ui.js:8131: WARNING - Parse error. Non-JSDoc comment has annotations. Did you mean to start it with '/**'?

^

jquery-ui.js:8147: WARNING - Parse error. Non-JSDoc comment has annotations. Did you mean to start it with '/**'?

^

jquery-ui.js:8161: WARNING - Parse error. Non-JSDoc comment has annotations. Did you mean to start it with '/**'?

^

jquery-ui.js:8222: WARNING - Parse error. Non-JSDoc comment has annotations. Did you mean to start it with '/**'?

^

jquery-ui.js:8232: WARNING - Parse error. Non-JSDoc comment has annotations. Did you mean to start it with '/**'?

^

jquery-ui.js:8245: WARNING - Parse error. Non-JSDoc comment has annotations. Did you mean to start it with '/**'?

^

jquery-ui.js:8391: WARNING - Parse error. Non-JSDoc comment has annotations. Did you mean to start it with '/**'?

^

jquery-ui.js:8558: WARNING - Parse error. Non-JSDoc comment has annotations. Did you mean to start it with '/**'?

^

jquery-ui.js:8744: WARNING - Parse error. Non-JSDoc comment has annotations. Did you mean to start it with '/**'?

^

jquery-ui.js:8753: WARNING - Parse error. Non-JSDoc comment has annotations. Did you mean to start it with '/**'?

^

jquery-ui.js:8770: WARNING - Parse error. Non-JSDoc comment has annotations. Did you mean to start it with '/**'?

^

jquery-ui.js:8963: WARNING - Parse error. Non-JSDoc comment has annotations. Did you mean to start it with '/**'?

^

jquery-ui.js:9215: WARNING - Parse error. Non-JSDoc comment has annotations. Did you mean to start it with '/**'?

^

jquery-ui.js:9385: WARNING - Suspicious code. This code lacks side-effects. Is there a bug?
		dow;
		^

jquery-ui.js:14716: WARNING - Suspicious code. The result of the 'getprop' operator is not being used.
			active.id;
			^

0 error(s), 21 warning(s)
...
d(this).removeClass("ui-datepicker-next-hover")}).delegate("button, .ui-datepicker-prev, .ui-datepicker-next, .ui-datepicker-calendar td a","mouseover",function(){d.datepicker._isDisabledDatepicker(Q.inline?a.parent()[0]:Q.input[0])||(d(this).parents(".ui-datepicker-calendar").find("a").removeClass("ui-state-hover"),d(this).addClass("ui-state-hover"),-1!==this.className.indexOf("ui-datepicker-prev")&&d(this).addClass("ui-datepicker-prev-hover"),-1!==this.className.indexOf("ui-datepicker-next")&&d(this).addClass("ui-datepicker-next-hover"))})}
function J(a,b){d.extend(a,b);for(var c in b)null==b[c]&&(a[c]=b[c]);return a}function A(a){return function(){var b=this.element.val();a.apply(this,arguments);this._refresh();b!==this.element.val()&&this._trigger("change")}}d.ui=d.ui||{};d.extend(d.ui,{version:"1.11.0",keyCode:{BACKSPACE:8,COMMA:188,DELETE:46,DOWN:40,END:35,ENTER:13,ESCAPE:27,HOME:36,LEFT:37,PAGE_DOWN:34,PAGE_UP:33,PERIOD:190,RIGHT:39,SPACE:32,TAB:9,UP:38}});d.fn.extend({scrollParent:function(){var a=this.css("position"),b="absolute"===
...
d.expr.createPseudo(function(a){return function(b){return!!d.data(b,a)}}):function(a,b,c){return!!d.data(a,c[3])},focusable:function(a){return S(a,!isNaN(d.attr(a,"tabindex")))},tabbable:function(a){var b=d.attr(a,"tabindex"),c=isNaN(b);return(c||0<=b)&&S(a,!c)}});d("<a>").outerWidth(1).jquery||d.each(["Width","Height"],function(a,b){function c(a,b,c,e){d.each(f,function(){b-=parseFloat(d.css(a,"padding"+this))||0;c&&(b-=parseFloat(d.css(a,"border"+this+"Width"))||0);e&&(b-=parseFloat(d.css(a,"margin"+
this))||0)});return b}var f="Width"===b?["Left","Right"]:["Top","Bottom"],e=b.toLowerCase(),g={innerWidth:d.fn.innerWidth,innerHeight:d.fn.innerHeight,outerWidth:d.fn.outerWidth,outerHeight:d.fn.outerHeight};d.fn["inner"+b]=function(a){return void 0===a?g["inner"+b].call(this):this.each(function(){d(this).css(e,c(this,a)+"px")})};d.fn["outer"+b]=function(a,f){return"number"!==typeof a?g["outer"+b].call(this,a):this.each(function(){d(this).css(e,c(this,a,!0,f)+"px")})}});d.fn.addBack||(d.fn.addBack=
...
parseInt(a.css("zIndex"),10),!isNaN(b)&&0!==b)return b;a=a.parent()}}return 0}});d.ui.plugin={add:function(a,b,c){var f;a=d.ui[a].prototype;for(f in c)a.plugins[f]=a.plugins[f]||[],a.plugins[f].push([b,c[f]])},call:function(a,b,c,d){if((b=a.plugins[b])&&(d||a.element[0].parentNode&&11!==a.element[0].parentNode.nodeType))for(d=0;d<b.length;d++)a.options[b[d][0]]&&b[d][1].apply(a.element,c)}};var Z=0,W=Array.prototype.slice;d.cleanData=function(a){return function(b){for(var c=0,f;null!=(f=b[c]);c++)try{d(f).triggerHandler("remove")}catch(e){}a(b)}}(d.cleanData);
d.widget=function(a,b,c){var f,e,g,h,k={},l=a.split(".")[0];a=a.split(".")[1];f=l+"-"+a;c||(c=b,b=d.Widget);d.expr[":"][f.toLowerCase()]=function(a){return!!d.data(a,f)};d[l]=d[l]||{};e=d[l][a];g=d[l][a]=function(a,b){if(!this._createWidget)return new g(a,b);arguments.length&&this._createWidget(a,b)};d.extend(g,e,{version:c.version,_proto:d.extend({},c),_childConstructors:[]});h=new b;h.options=d.widget.extend({},h.options);d.each(c,function(a,c){d.isFunction(c)?k[a]=function(){var d=function(){return b.prototype[a].apply(this,
...
b._childConstructors.push(g);d.widget.bridge(a,g);return g};d.widget.extend=function(a){for(var b=W.call(arguments,1),c=0,f=b.length,e,g;c<f;c++)for(e in b[c])g=b[c][e],b[c].hasOwnProperty(e)&&void 0!==g&&(d.isPlainObject(g)?a[e]=d.isPlainObject(a[e])?d.widget.extend({},a[e],g):d.widget.extend({},g):a[e]=g);return a};d.widget.bridge=function(a,b){var c=b.prototype.widgetFullName||a;d.fn[a]=function(f){var e="string"===typeof f,g=W.call(arguments,1),h=this;f=!e&&g.length?d.widget.extend.apply(null,
[f].concat(g)):f;e?this.each(function(){var b,e=d.data(this,c);if("instance"===f)return h=e,!1;if(!e)return d.error("cannot call methods on "+a+" prior to initialization; attempted to call method '"+f+"'");if(!d.isFunction(e[f])||"_"===f.charAt(0))return d.error("no such method '"+f+"' for "+a+" widget instance");b=e[f].apply(e,g);if(b!==e&&void 0!==b)return h=b&&b.jquery?h.pushStack(b.get()):b,!1}):this.each(function(){var a=d.data(this,c);a?(a.option(f||{}),a._init&&a._init()):d.data(this,c,new b(f,
...
this.widget().unbind(this.eventNamespace).removeAttr("aria-disabled").removeClass(this.widgetFullName+"-disabled ui-state-disabled");this.bindings.unbind(this.eventNamespace);this.hoverable.removeClass("ui-state-hover");this.focusable.removeClass("ui-state-focus")},_destroy:d.noop,widget:function(){return this.element},option:function(a,b){var c=a,f,e,g;if(0===arguments.length)return d.widget.extend({},this.options);if("string"===typeof a)if(c={},f=a.split("."),a=f.shift(),f.length){e=c[a]=d.widget.extend({},
this.options[a]);for(g=0;g<f.length-1;g++)e[f[g]]=e[f[g]]||{},e=e[f[g]];a=f.pop();if(1===arguments.length)return void 0===e[a]?null:e[a];e[a]=b}else{if(1===arguments.length)return void 0===this.options[a]?null:this.options[a];c[a]=b}this._setOptions(c);return this},_setOptions:function(a){for(var b in a)this._setOption(b,a[b]);return this},_setOption:function(a,b){this.options[a]=b;"disabled"===a&&(this.widget().toggleClass(this.widgetFullName+"-disabled",!!b),b&&(this.hoverable.removeClass("ui-state-hover"),
...
b.preventDefault?{width:0,height:0,offset:{top:b.pageY,left:b.pageX}}:{width:a.outerWidth(),height:a.outerHeight(),offset:a.offset()}}d.ui=d.ui||{};var c,f,e=Math.max,g=Math.abs,h=Math.round,k=/left|center|right/,l=/top|center|bottom/,m=/[\+\-]\d+(\.[\d]+)?%?/,n=/^\w+/,p=/%$/,s=d.fn.position;d.position={scrollbarWidth:function(){if(void 0!==c)return c;var a,b,f=d("<div style='display:block;position:absolute;width:50px;height:50px;overflow:hidden;'><div style='height:100px;width:auto;'></div></div>");
...
getWithinInfo:function(a){a=d(a||window);var b=d.isWindow(a[0]);return{element:a,isWindow:b,isDocument:!!a[0]&&9===a[0].nodeType,offset:a.offset()||{left:0,top:0},scrollLeft:a.scrollLeft(),scrollTop:a.scrollTop(),width:b?a.width():a.outerWidth(),height:b?a.height():a.outerHeight()}}};d.fn.position=function(c){if(!c||!c.of)return s.apply(this,arguments);c=d.extend({},c);var q,r,u,p,v,C,x=d(c.of),B=d.position.getWithinInfo(c.within),y=d.position.getScrollInfo(B),I=(c.collision||"flip").split(" "),K=
{};C=b(x);x[0].preventDefault&&(c.at="left top");r=C.width;u=C.height;p=C.offset;v=d.extend({},p);d.each(["my","at"],function(){var a=(c[this]||"").split(" "),b,d;1===a.length&&(a=k.test(a[0])?a.concat(["center"]):l.test(a[0])?["center"].concat(a):["center","center"]);a[0]=k.test(a[0])?a[0]:"center";a[1]=l.test(a[1])?a[1]:"center";b=m.exec(a[0]);d=m.exec(a[1]);K[this]=[b?b[0]:0,d?d[0]:0];c[this]=[n.exec(a[0])[0],n.exec(a[1])[0]]});1===I.length&&(I[1]=I[0]);"right"===c.at[0]?v.left+=r:"center"===c.at[0]&&
(v.left+=r/2);"bottom"===c.at[1]?v.top+=u:"center"===c.at[1]&&(v.top+=u/2);q=a(K.at,r,u);v.left+=q[0];v.top+=q[1];return this.each(function(){var b,k,l=d(this),m=l.outerWidth(),n=l.outerHeight(),C=parseInt(d.css(this,"marginLeft"),10)||0,s=parseInt(d.css(this,"marginTop"),10)||0,A=m+C+(parseInt(d.css(this,"marginRight"),10)||0)+y.width,N=n+s+(parseInt(d.css(this,"marginBottom"),10)||0)+y.height,w=d.extend({},v),F=a(K.my,l.outerWidth(),l.outerHeight());"right"===c.my[0]?w.left-=m:"center"===c.my[0]&&
(w.left-=m/2);"bottom"===c.my[1]?w.top-=n:"center"===c.my[1]&&(w.top-=n/2);w.left+=F[0];w.top+=F[1];f||(w.left=h(w.left),w.top=h(w.top));b={marginLeft:C,marginTop:s};d.each(["left","top"],function(a,f){if(d.ui.position[I[a]])d.ui.position[I[a]][f](w,{targetWidth:r,targetHeight:u,elemWidth:m,elemHeight:n,collisionPosition:b,collisionWidth:A,collisionHeight:N,offset:[q[0]+F[0],q[1]+F[1]],my:c.my,at:c.at,within:B,elem:l})});c.using&&(k=function(a){var b=p.left-w.left,d=b+r-m,f=p.top-w.top,h=f+u-n,k=
{target:{element:x,left:p.left,top:p.top,width:r,height:u},element:{element:l,left:w.left,top:w.top,width:m,height:n},horizontal:0>d?"left":0<b?"right":"center",vertical:0>h?"top":0<f?"bottom":"middle"};r<m&&g(b+d)<r&&(k.horizontal="center");u<n&&g(f+h)<u&&(k.vertical="middle");e(g(b),g(d))>e(g(f),g(h))?k.important="horizontal":k.important="vertical";c.using.call(this,a,k)});l.offset(d.extend(w,{using:k}))})};d.ui.position={fit:{left:function(a,b){var c=b.within,d=c.isWindow?c.scrollLeft:c.offset.left,
...
c?d:c>h?d+f-b.collisionHeight:d:a.top=0<c?a.top+c:0<h?a.top-h:e(a.top-g,a.top)}},flip:{left:function(a,b){var c=b.within,d=c.offset.left+c.scrollLeft,f=c.width,e=c.isWindow?c.scrollLeft:c.offset.left,h=a.left-b.collisionPosition.marginLeft,c=h-e,k=h+b.collisionWidth-f-e,h="left"===b.my[0]?-b.elemWidth:"right"===b.my[0]?b.elemWidth:0,l="left"===b.at[0]?b.targetWidth:"right"===b.at[0]?-b.targetWidth:0,m=-2*b.offset[0];if(0>c){if(d=a.left+h+l+m+b.collisionWidth-f-d,0>d||d<g(c))a.left+=h+l+m}else 0<k&&
(d=a.left-b.collisionPosition.marginLeft+h+l+m-e,0<d||g(d)<k)&&(a.left+=h+l+m)},top:function(a,b){var c=b.within,d=c.offset.top+c.scrollTop,f=c.height,e=c.isWindow?c.scrollTop:c.offset.top,h=a.top-b.collisionPosition.marginTop,c=h-e,k=h+b.collisionHeight-f-e,h="top"===b.my[1]?-b.elemHeight:"bottom"===b.my[1]?b.elemHeight:0,l="top"===b.at[1]?b.targetHeight:"bottom"===b.at[1]?-b.targetHeight:0,m=-2*b.offset[1];0>c?(d=a.top+h+l+m+b.collisionHeight-f-d,a.top+h+l+m>c&&(0>d||d<g(c))&&(a.top+=h+l+m)):0<
k&&(d=a.top-b.collisionPosition.marginTop+h+l+m-e,a.top+h+l+m>k&&(0<d||g(d)<k)&&(a.top+=h+l+m))}},flipfit:{left:function(){d.ui.position.flip.left.apply(this,arguments);d.ui.position.fit.left.apply(this,arguments)},top:function(){d.ui.position.flip.top.apply(this,arguments);d.ui.position.fit.top.apply(this,arguments)}}};(function(){var a,b,c,e,g=document.getElementsByTagName("body")[0];c=document.createElement("div");a=document.createElement(g?"div":"body");b={visibility:"hidden",width:0,height:0,
...
a._opacity)}});d.ui.plugin.add("draggable","scroll",{start:function(a,b,c){c.scrollParent[0]!==c.document[0]&&"HTML"!==c.scrollParent[0].tagName&&(c.overflowOffset=c.scrollParent.offset())},drag:function(a,b,c){b=c.options;var f=!1,e=c.document[0];c.scrollParent[0]!==e&&"HTML"!==c.scrollParent[0].tagName?(b.axis&&"x"===b.axis||(c.overflowOffset.top+c.scrollParent[0].offsetHeight-a.pageY<b.scrollSensitivity?c.scrollParent[0].scrollTop=f=c.scrollParent[0].scrollTop+b.scrollSpeed:a.pageY-c.overflowOffset.top<
b.scrollSensitivity&&(c.scrollParent[0].scrollTop=f=c.scrollParent[0].scrollTop-b.scrollSpeed)),b.axis&&"y"===b.axis||(c.overflowOffset.left+c.scrollParent[0].offsetWidth-a.pageX<b.scrollSensitivity?c.scrollParent[0].scrollLeft=f=c.scrollParent[0].scrollLeft+b.scrollSpeed:a.pageX-c.overflowOffset.left<b.scrollSensitivity&&(c.scrollParent[0].scrollLeft=f=c.scrollParent[0].scrollLeft-b.scrollSpeed))):(b.axis&&"x"===b.axis||(a.pageY-d(e).scrollTop()<b.scrollSensitivity?f=d(e).scrollTop(d(e).scrollTop()-
b.scrollSpeed):d(window).height()-(a.pageY-d(e).scrollTop())<b.scrollSensitivity&&(f=d(e).scrollTop(d(e).scrollTop()+b.scrollSpeed))),b.axis&&"y"===b.axis||(a.pageX-d(e).scrollLeft()<b.scrollSensitivity?f=d(e).scrollLeft(d(e).scrollLeft()-b.scrollSpeed):d(window).width()-(a.pageX-d(e).scrollLeft())<b.scrollSensitivity&&(f=d(e).scrollLeft(d(e).scrollLeft()+b.scrollSpeed))));!1!==f&&d.ui.ddmanager&&!b.dropBehaviour&&d.ui.ddmanager.prepareOffsets(c,a)}});d.ui.plugin.add("draggable","snap",{start:function(a,
b,c){a=c.options;c.snapElements=[];d(a.snap.constructor!==String?a.snap.items||":data(ui-draggable)":a.snap).each(function(){var a=d(this),b=a.offset();this!==c.element[0]&&c.snapElements.push({item:this,width:a.outerWidth(),height:a.outerHeight(),top:b.top,left:b.left})})},drag:function(a,b,c){var f,e,g,h,k,l,m,n,p,s,t=c.options,q=t.snapTolerance,r=b.offset.left,u=r+c.helperProportions.width,E=b.offset.top,v=E+c.helperProportions.height;for(p=c.snapElements.length-1;0<=p;p--)k=c.snapElements[p].left,
l=k+c.snapElements[p].width,m=c.snapElements[p].top,n=m+c.snapElements[p].height,u<k-q||r>l+q||v<m-q||E>n+q||!d.contains(c.snapElements[p].item.ownerDocument,c.snapElements[p].item)?(c.snapElements[p].snapping&&c.options.snap.release&&c.options.snap.release.call(c.element,a,d.extend(c._uiHash(),{snapItem:c.snapElements[p].item})),c.snapElements[p].snapping=!1):("inner"!==t.snapMode&&(f=Math.abs(m-v)<=q,e=Math.abs(n-E)<=q,g=Math.abs(k-u)<=q,h=Math.abs(l-r)<=q,f&&(b.position.top=c._convertPositionTo("relative",
{top:m-c.helperProportions.height,left:0}).top-c.margins.top),e&&(b.position.top=c._convertPositionTo("relative",{top:n,left:0}).top-c.margins.top),g&&(b.position.left=c._convertPositionTo("relative",{top:0,left:k-c.helperProportions.width}).left-c.margins.left),h&&(b.position.left=c._convertPositionTo("relative",{top:0,left:l}).left-c.margins.left)),s=f||e||g||h,"outer"!==t.snapMode&&(f=Math.abs(m-E)<=q,e=Math.abs(n-v)<=q,g=Math.abs(k-r)<=q,h=Math.abs(l-u)<=q,f&&(b.position.top=c._convertPositionTo("relative",
{top:m,left:0}).top-c.margins.top),e&&(b.position.top=c._convertPositionTo("relative",{top:n-c.helperProportions.height,left:0}).top-c.margins.top),g&&(b.position.left=c._convertPositionTo("relative",{top:0,left:k}).left-c.margins.left),h&&(b.position.left=c._convertPositionTo("relative",{top:0,left:l-c.helperProportions.width}).left-c.margins.left)),!c.snapElements[p].snapping&&(f||e||g||h||s)&&c.options.snap.snap&&c.options.snap.snap.call(c.element,a,d.extend(c._uiHash(),{snapItem:c.snapElements[p].item})),
c.snapElements[p].snapping=f||e||g||h||s)}});d.ui.plugin.add("draggable","stack",{start:function(a,b,c){var f;a=d.makeArray(d(c.options.stack)).sort(function(a,b){return(parseInt(d(a).css("zIndex"),10)||0)-(parseInt(d(b).css("zIndex"),10)||0)});a.length&&(f=parseInt(d(a[0]).css("zIndex"),10)||0,d(a).each(function(a){d(this).css("zIndex",f+a)}),this.css("zIndex",f+a.length))}});d.ui.plugin.add("draggable","zIndex",{start:function(a,b,c){a=d(b.helper);c=c.options;a.css("zIndex")&&(c._zIndex=a.css("zIndex"));
...
l=this.position.top+this.size.height,m=/sw|nw|w/.test(c),c=/nw|ne|n/.test(c);g&&(a.width=b.minWidth);h&&(a.height=b.minHeight);d&&(a.width=b.maxWidth);e&&(a.height=b.maxHeight);g&&m&&(a.left=k-b.minWidth);d&&m&&(a.left=k-b.maxWidth);h&&c&&(a.top=l-b.minHeight);e&&c&&(a.top=l-b.maxHeight);a.width||a.height||a.left||!a.top?a.width||a.height||a.top||!a.left||(a.left=null):a.top=null;return a},_proportionallyResize:function(){if(this._proportionallyResizeElements.length){var a,b,c,d,e,g=this.helper||
this.element;for(a=0;a<this._proportionallyResizeElements.length;a++){e=this._proportionallyResizeElements[a];if(!this.borderDif)for(this.borderDif=[],c=[e.css("borderTopWidth"),e.css("borderRightWidth"),e.css("borderBottomWidth"),e.css("borderLeftWidth")],d=[e.css("paddingTop"),e.css("paddingRight"),e.css("paddingBottom"),e.css("paddingLeft")],b=0;b<c.length;b++)this.borderDif[b]=(parseInt(c[b],10)||0)+(parseInt(d[b],10)||0);e.css({height:g.height()-this.borderDif[0]-this.borderDif[2]||0,width:g.width()-
...
10)+(b.position.top-b.originalPosition.top)||null;b.element.animate(d.extend(e,h&&g?{top:h,left:g}:{}),{duration:c.animateDuration,easing:c.animateEasing,step:function(){var c={width:parseInt(b.element.css("width"),10),height:parseInt(b.element.css("height"),10),top:parseInt(b.element.css("top"),10),left:parseInt(b.element.css("left"),10)};f&&f.length&&d(f[0]).css({width:c.width,height:c.height});b._updateCache(c);b._propagate("resize",a)}})}});d.ui.plugin.add("resizable","containment",{start:function(){var a,
...
d))}),g.containerOffset=a.offset(),g.containerPosition=a.position(),g.containerSize={height:a.innerHeight()-b[3],width:a.innerWidth()-b[1]},c=g.containerOffset,f=g.containerSize.height,e=g.containerSize.width,e=g._hasScroll(h,"left")?h.scrollWidth:e,f=g._hasScroll(h)?h.scrollHeight:f,g.parentData={element:h,left:c.left,top:c.top,width:e,height:f})},resize:function(a,b){var c,f,e,g,h=d(this).resizable("instance");c=h.options;f=h.containerOffset;g=h.position;var k=h._aspectRatio||a.shiftKey;e={top:0,
left:0};var l=h.containerElement,m=!0;l[0]!==document&&/static/.test(l.css("position"))&&(e=f);g.left<(h._helper?f.left:0)&&(h.size.width+=h._helper?h.position.left-f.left:h.position.left-e.left,k&&(h.size.height=h.size.width/h.aspectRatio,m=!1),h.position.left=c.helper?f.left:0);g.top<(h._helper?f.top:0)&&(h.size.height+=h._helper?h.position.top-f.top:h.position.top,k&&(h.size.width=h.size.height*h.aspectRatio,m=!1),h.position.top=h._helper?f.top:0);h.offset.left=h.parentData.left+h.position.left;
h.offset.top=h.parentData.top+h.position.top;c=Math.abs((h._helper?h.offset.left-e.left:h.offset.left-f.left)+h.sizeDiff.width);f=Math.abs((h._helper?h.offset.top-e.top:h.offset.top-f.top)+h.sizeDiff.height);e=h.containerElement.get(0)===h.element.parent().get(0);g=/relative|absolute/.test(h.containerElement.css("position"));e&&g&&(c-=Math.abs(h.parentData.left));c+h.size.width>=h.parentData.width&&(h.size.width=h.parentData.width-c,k&&(h.size.height=h.size.width/h.aspectRatio,m=!1));f+h.size.height>=
h.parentData.height&&(h.size.height=h.parentData.height-f,k&&(h.size.width=h.size.height*h.aspectRatio,m=!1));m||(h.position.left=b.prevPosition.left,h.position.top=b.prevPosition.top,h.size.width=b.prevSize.width,h.size.height=b.prevSize.height)},stop:function(){var a=d(this).resizable("instance"),b=a.options,c=a.containerOffset,f=a.containerPosition,e=a.containerElement,g=d(a.helper),h=g.offset(),k=g.outerWidth()-a.sizeDiff.width,g=g.outerHeight()-a.sizeDiff.height;a._helper&&!b.animate&&/relative/.test(e.css("position"))&&
d(this).css({left:h.left-f.left-c.left,width:k,height:g});a._helper&&!b.animate&&/static/.test(e.css("position"))&&d(this).css({left:h.left-f.left-c.left,width:k,height:g})}});d.ui.plugin.add("resizable","alsoResize",{start:function(){var a=d(this).resizable("instance").options,b=function(a){d(a).each(function(){var a=d(this);a.data("ui-resizable-alsoresize",{width:parseInt(a.width(),10),height:parseInt(a.height(),10),left:parseInt(a.css("left"),10),top:parseInt(a.css("top"),10)})})};"object"!==typeof a.alsoResize||
...
b=a.options,c=a.size,f=a.originalSize,e=a.originalPosition,g=a.axis,h="number"===typeof b.grid?[b.grid,b.grid]:b.grid,k=h[0]||1,l=h[1]||1,m=Math.round((c.width-f.width)/k)*k,c=Math.round((c.height-f.height)/l)*l,n=f.width+m,p=f.height+c,s=b.maxWidth&&b.maxWidth<n,t=b.maxHeight&&b.maxHeight<p,q=b.minWidth&&b.minWidth>n,r=b.minHeight&&b.minHeight>p;b.grid=h;q&&(n+=k);r&&(p+=l);s&&(n-=k);t&&(p-=l);/^(se|s|e)$/.test(g)?(a.size.width=n,a.size.height=p):/^(ne)$/.test(g)?(a.size.width=n,a.size.height=p,
a.position.top=e.top-c):/^(sw)$/.test(g)?(a.size.width=n,a.size.height=p,a.position.left=e.left-m):(0<p-l?(a.size.height=p,a.position.top=e.top-c):(a.size.height=l,a.position.top=e.top+f.height-l),0<n-k?(a.size.width=n,a.position.left=e.left-m):(a.size.width=k,a.position.left=e.left+f.width-k))}});d.widget("ui.selectable",d.ui.mouse,{version:"1.11.0",options:{appendTo:"body",autoRefresh:!0,distance:0,filter:"*",tolerance:"touch",selected:null,selecting:null,start:null,stop:null,unselected:null,unselecting:null},
...
!d.contains(this.element[0],f):1)){this.direction=1===e?"down":"up";if("pointer"===this.options.tolerance||this._intersectsWithSides(c))this._rearrange(a,c);else break;this._trigger("change",a,this._uiHash());break}this._contactContainers(a);d.ui.ddmanager&&d.ui.ddmanager.drag(this,a);this._trigger("sort",a,this._uiHash());this.lastPositionAbs=this.positionAbs;return!1},_mouseStop:function(a,b){if(a){d.ui.ddmanager&&!this.options.dropBehaviour&&d.ui.ddmanager.drop(this,a);if(this.options.revert){var c=
...
(h=this.items[c].item.offset()[e],k=!1,a[l]-h>this.items[c][g]/2&&(k=!0),Math.abs(a[l]-h)<b&&(b=Math.abs(a[l]-h),f=this.items[c],this.direction=k?"up":"down"));(f||this.options.dropOnEmpty)&&this.currentContainer!==this.containers[m]&&(f?this._rearrange(a,f,null,!0):this._rearrange(a,null,this.containers[m].element,!0),this._trigger("change",a,this._uiHash()),this.containers[m]._trigger("change",a,this._uiHash(this)),this.currentContainer=this.containers[m],this.options.placeholder.update(this.currentContainer,
...
"false").prev().attr({"aria-selected":"true",tabIndex:0,"aria-expanded":"true"})},_animate:function(a,b,c){var d,e,g,h=this,k=0,l=a.length&&(!b.length||a.index()<b.index()),m=this.options.animate||{},l=l&&m.down||m,n=function(){h._toggleComplete(c)};"number"===typeof l&&(g=l);"string"===typeof l&&(e=l);e=e||l.easing||m.easing;g=g||l.duration||m.duration;if(!b.length)return a.animate(this.showProps,g,e,n);if(!a.length)return b.animate(this.hideProps,g,e,n);d=a.show().outerHeight();b.animate(this.hideProps,
{duration:g,easing:e,step:function(a,b){b.now=Math.round(a)}});a.hide().animate(this.showProps,{duration:g,easing:e,complete:n,step:function(a,c){c.now=Math.round(a);"height"!==c.prop?k+=c.now:"content"!==h.options.heightStyle&&(c.now=Math.round(d-b.outerHeight()-k),k=0)}})},_toggleComplete:function(a){var b=a.oldPanel;b.removeClass("ui-accordion-content-active").prev().removeClass("ui-corner-top").addClass("ui-corner-all");b.length&&(b.parent()[0].className=b.parent()[0].className);this._trigger("activate",
...
f);break;case e.PAGE_DOWN:a=!0;this._move("nextPage",f);break;case e.UP:a=!0;this._keyEvent("previous",f);break;case e.DOWN:a=!0;this._keyEvent("next",f);break;case e.ENTER:this.menu.active&&(a=!0,f.preventDefault(),this.menu.select(f));break;case e.TAB:this.menu.active&&this.menu.select(f);break;case e.ESCAPE:this.menu.element.is(":visible")&&(this._value(this.term),this.close(f),f.preventDefault());break;default:b=!0,this._searchTimeout(f)}}},keypress:function(c){if(a)a=!1,this.isMultiLine&&!this.menu.element.is(":visible")||
c.preventDefault();else if(!b){var f=d.ui.keyCode;switch(c.keyCode){case f.PAGE_UP:this._move("previousPage",c);break;case f.PAGE_DOWN:this._move("nextPage",c);break;case f.UP:this._keyEvent("previous",c);break;case f.DOWN:this._keyEvent("next",c)}}},input:function(a){c?(c=!1,a.preventDefault()):this._searchTimeout(a)},focus:function(){this.selectedItem=null;this.previous=this._value()},blur:function(a){this.cancelBlur?delete this.cancelBlur:(clearTimeout(this.searching),this.close(a),this._change(a))}});
...
" result is")+" available, use up and down arrow keys to navigate."}}},__response:function(a){var b;this._superApply(arguments);this.options.disabled||this.cancelSearch||(b=a&&a.length?this.options.messages.results(a.length):this.options.messages.noResults,this.liveRegion.children().hide(),d("<div>").text(b).appendTo(this.liveRegion))}});var R,$=function(){var a=d(this);setTimeout(function(){a.find(":ui-button").button("refresh")},1)},X=function(a){var b=a.name,c=a.form,f=d([]);b&&(b=b.replace(/'/g,
"\\'"),f=c?d(c).find("[name='"+b+"'][type=radio]"):d("[name='"+b+"'][type=radio]",a.ownerDocument).filter(function(){return!this.form}));return f};d.widget("ui.button",{version:"1.11.0",defaultElement:"<button>",options:{disabled:null,text:!0,label:null,icons:{primary:null,secondary:null}},_create:function(){this.element.closest("form").unbind("reset"+this.eventNamespace).bind("reset"+this.eventNamespace,$);"boolean"!==typeof this.options.disabled?this.options.disabled=!!this.element.prop("disabled"):
...
e.push("ui-button-text-icon"+(f?"s":c.primary?"-primary":"-secondary")),c.primary&&a.prepend("<span class='ui-button-icon-primary ui-icon "+c.primary+"'></span>"),c.secondary&&a.append("<span class='ui-button-icon-secondary ui-icon "+c.secondary+"'></span>"),this.options.text||(e.push(f?"ui-button-icons-only":"ui-button-icon-only"),this.hasTitle||a.attr("title",d.trim(b)))):e.push("ui-button-text-only");a.addClass(e.join(" "))}}});d.widget("ui.buttonset",{version:"1.11.0",options:{items:"button, input[type=button], input[type=submit], input[type=reset], input[type=checkbox], input[type=radio], a, :data(ui-button)"},
...
"ui-corner-right":"ui-corner-left").end().filter(":last").addClass(a?"ui-corner-left":"ui-corner-right").end().end()},_destroy:function(){this.element.removeClass("ui-buttonset");this.buttons.map(function(){return d(this).button("widget")[0]}).removeClass("ui-corner-left ui-corner-right").end().button("destroy")}});d.extend(d.ui,{datepicker:{version:"1.11.0"}});var Q;d.extend(U.prototype,{markerClassName:"hasDatepicker",maxRows:4,_widgetDatepicker:function(){return this.dpDiv},setDefaults:function(a){J(this._defaults,
...
this._disableDatepicker(a),b.dpDiv.css("display","block"))},_dialogDatepicker:function(a,b,c,f,e){var g;a=this._dialogInst;a||(this.uuid+=1,a="dp"+this.uuid,this._dialogInput=d("<input type='text' id='"+a+"' style='position: absolute; top: -100px; width: 0px;'/>"),this._dialogInput.keydown(this._doKeyDown),d("body").append(this._dialogInput),a=this._dialogInst=this._newInst(this._dialogInput,!1),a.settings={},d.data(this._dialogInput[0],"datepicker",a));J(a.settings,f||{});b=b&&b.constructor===Date?
...
typeof b)return"defaults"===b?d.extend({},d.datepicker._defaults):k?"all"===b?d.extend({},k.settings):this._get(k,b):null;f=b||{};"string"===typeof b&&(f={},f[b]=c);k&&(this._curInst===k&&this._hideDatepicker(),e=this._getDateDatepicker(a,!0),g=this._getMinMaxDate(k,"min"),h=this._getMinMaxDate(k,"max"),J(k.settings,f),null!==g&&void 0!==f.dateFormat&&void 0===f.minDate&&(k.settings.minDate=this._formatDate(k,g)),null!==h&&void 0!==f.dateFormat&&void 0===f.maxDate&&(k.settings.maxDate=this._formatDate(k,
...
c.apply(a,[a,b]):{};if(!1!==c&&(J(b.settings,c),b.lastVal=null,d.datepicker._lastInput=a,d.datepicker._setDateFromField(b),d.datepicker._inDialog&&(a.value=""),d.datepicker._pos||(d.datepicker._pos=d.datepicker._findPos(a),d.datepicker._pos[1]+=a.offsetHeight),f=!1,d(a).parents().each(function(){f|="fixed"===d(this).css("position");return!f}),c={left:d.datepicker._pos[0],top:d.datepicker._pos[1]},d.datepicker._pos=null,b.dpDiv.empty(),b.dpDiv.css({position:"absolute",display:"block",top:"-1000px"}),
d.datepicker._updateDatepicker(b),c=d.datepicker._checkOffset(b,c,f),b.dpDiv.css({position:d.datepicker._inDialog&&d.blockUI?"static":f?"fixed":"absolute",display:"none",left:c.left+"px",top:c.top+"px"}),!b.inline)){c=d.datepicker._get(b,"showAnim");e=d.datepicker._get(b,"duration");b.dpDiv.css("z-index",Y(d(a))+1);d.datepicker._datepickerShowing=!0;if(d.effects&&d.effects.effect[c])b.dpDiv.show(c,d.datepicker._get(b,"showOptions"),e);else b.dpDiv[c||"show"](c?e:null);d.datepicker._shouldFocusInput(b)&&
b.input.focus();d.datepicker._curInst=b}}},_updateDatepicker:function(a){this.maxRows=4;Q=a;a.dpDiv.empty().append(this._generateHTML(a));this._attachHandlers(a);a.dpDiv.find("."+this._dayOverClass+" a");var b,c=this._getNumberOfMonths(a),f=c[1];a.dpDiv.removeClass("ui-datepicker-multi-2 ui-datepicker-multi-3 ui-datepicker-multi-4").width("");1<f&&a.dpDiv.addClass("ui-datepicker-multi-"+f).css("width",17*f+"em");a.dpDiv[(1!==c[0]||1!==c[1]?"add":"remove")+"Class"]("ui-datepicker-multi");a.dpDiv[(this._get(a,
"isRTL")?"add":"remove")+"Class"]("ui-datepicker-rtl");a===d.datepicker._curInst&&d.datepicker._datepickerShowing&&d.datepicker._shouldFocusInput(a)&&a.input.focus();a.yearshtml&&(b=a.yearshtml,setTimeout(function(){b===a.yearshtml&&a.yearshtml&&a.dpDiv.find("select.ui-datepicker-year:first").replaceWith(a.yearshtml);b=a.yearshtml=null},0))},_shouldFocusInput:function(a){return a.input&&a.input.is(":visible")&&!a.input.is(":disabled")&&!a.input.is(":focus")},_checkOffset:function(a,b,c){var f=a.dpDiv.outerWidth(),
e=a.dpDiv.outerHeight(),g=a.input?a.input.outerWidth():0,h=a.input?a.input.outerHeight():0,k=document.documentElement.clientWidth+(c?0:d(document).scrollLeft()),l=document.documentElement.clientHeight+(c?0:d(document).scrollTop());b.left-=this._get(a,"isRTL")?f-g:0;b.left-=c&&b.left===a.input.offset().left?d(document).scrollLeft():0;b.top-=c&&b.top===a.input.offset().top+h?d(document).scrollTop():0;b.left-=Math.min(b.left,b.left+f>k&&k>f?Math.abs(b.left+f-k):0);b.top-=Math.min(b.top,b.top+e>l&&l>
e?Math.abs(e+h):0);return b},_findPos:function(a){for(var b=this._getInst(a),b=this._get(b,"isRTL");a&&("hidden"===a.type||1!==a.nodeType||d.expr.filters.hidden(a));)a=a[b?"previousSibling":"nextSibling"];a=d(a).offset();return[a.left,a.top]},_hideDatepicker:function(a){var b,c,f=this._curInst;if(f&&(!a||f===d.data(a,"datepicker"))&&this._datepickerShowing){a=this._get(f,"showAnim");b=this._get(f,"duration");c=function(){d.datepicker._tidyDialog(f)};if(d.effects&&(d.effects.effect[a]||d.effects[a]))f.dpDiv.hide(a,
d.datepicker._get(f,"showOptions"),b,c);else f.dpDiv["slideDown"===a?"slideUp":"fadeIn"===a?"fadeOut":"hide"](a?b:null,c);a||c();this._datepickerShowing=!1;(a=this._get(f,"onClose"))&&a.apply(f.input?f.input[0]:null,[f.input?f.input.val():"",f]);this._lastInput=null;this._inDialog&&(this._dialogInput.css({position:"absolute",left:"0",top:"-100px"}),d.blockUI&&(d.unblockUI(),d("body").append(this.dpDiv)));this._inDialog=!1}},_tidyDialog:function(a){a.dpDiv.removeClass(this._dialogClass).unbind(".ui-datepicker-calendar")},
...
a||null==b)throw"Invalid arguments";b="object"===typeof b?b.toString():b+"";if(""===b)return null;var f,e,g,h=0;e=(c?c.shortYearCutoff:null)||this._defaults.shortYearCutoff;e="string"!==typeof e?e:(new Date).getFullYear()%100+parseInt(e,10);g=(c?c.dayNamesShort:null)||this._defaults.dayNamesShort;var k=(c?c.dayNames:null)||this._defaults.dayNames,l=(c?c.monthNamesShort:null)||this._defaults.monthNamesShort,m=(c?c.monthNames:null)||this._defaults.monthNames,n=c=-1,p=-1,s=-1,t=!1,q,r=function(b){(b=
f+1<a.length&&a.charAt(f+1)===b)&&f++;return b},u=function(a){var c=r(a);a=new RegExp("^\\d{1,"+("@"===a?14:"!"===a?20:"y"===a&&c?4:"o"===a?3:2)+"}");a=b.substring(h).match(a);if(!a)throw"Missing number at position "+h;h+=a[0].length;return parseInt(a[0],10)},E=function(a,c,f){var e=-1;a=d.map(r(a)?f:c,function(a,b){return[[b,a]]}).sort(function(a,b){return-(a[1].length-b[1].length)});d.each(a,function(a,c){var d=c[1];if(b.substr(h,d.length).toLowerCase()===d.toLowerCase())return e=c[0],h+=d.length,
!1});if(-1!==e)return e+1;throw"Unknown name at position "+h;},v=function(){if(b.charAt(h)!==a.charAt(f))throw"Unexpected literal at position "+h;h++};for(f=0;f<a.length;f++)if(t)"'"!==a.charAt(f)||r("'")?v():t=!1;else switch(a.charAt(f)){case "d":p=u("d");break;case "D":E("D",g,k);break;case "o":s=u("o");break;case "m":n=u("m");break;case "M":n=E("M",l,m);break;case "y":c=u("y");break;case "@":q=new Date(u("@"));c=q.getFullYear();n=q.getMonth()+1;p=q.getDate();break;case "!":q=new Date((u("!")-this._ticksTo1970)/
1E4);c=q.getFullYear();n=q.getMonth()+1;p=q.getDate();break;case "'":r("'")?v():t=!0;break;default:v()}if(h<b.length&&(g=b.substr(h),!/^\s+/.test(g)))throw"Extra/unparsed characters found in date: "+g;-1===c?c=(new Date).getFullYear():100>c&&(c+=(new Date).getFullYear()-(new Date).getFullYear()%100+(c<=e?0:-100));if(-1<s){n=1;p=s;do{e=this._getDaysInMonth(c,n-1);if(p<=e)break;n++;p-=e}while(1)}q=this._daylightSavingAdjust(new Date(c,n-1,p));if(q.getFullYear()!==c||q.getMonth()+1!==n||q.getDate()!==
p)throw"Invalid date";return q},ATOM:"yy-mm-dd",COOKIE:"D, dd M yy",ISO_8601:"yy-mm-dd",RFC_822:"D, d M y",RFC_850:"DD, dd-M-y",RFC_1036:"D, d M y",RFC_1123:"D, d M yy",RFC_2822:"D, d M yy",RSS:"D, d M y",TICKS:"!",TIMESTAMP:"@",W3C:"yy-mm-dd",_ticksTo1970:864E9*(718685+Math.floor(492.5)-Math.floor(19.7)+Math.floor(4.925)),formatDate:function(a,b,c){if(!b)return"";var d,e=(c?c.dayNamesShort:null)||this._defaults.dayNamesShort,g=(c?c.dayNames:null)||this._defaults.dayNames,h=(c?c.monthNamesShort:null)||
...
this);return!1},selectMonth:function(){d.datepicker._selectMonthYear(c,this,"M");return!1},selectYear:function(){d.datepicker._selectMonthYear(c,this,"Y");return!1}}[this.getAttribute("data-handler")])})},_generateHTML:function(a){var b,c,d,e,g,h,k,l,m,n,p,s,t,q,r,u,E,v,C,x,B,y,I,K,M,L,P,A=new Date,A=this._daylightSavingAdjust(new Date(A.getFullYear(),A.getMonth(),A.getDate())),G=this._get(a,"isRTL");h=this._get(a,"showButtonPanel");d=this._get(a,"hideIfNoPrevNext");g=this._get(a,"navigationAsDateFormat");
var H=this._getNumberOfMonths(a),z=this._get(a,"showCurrentAtPos");e=this._get(a,"stepMonths");var J=1!==H[0]||1!==H[1],N=this._daylightSavingAdjust(a.currentDay?new Date(a.currentYear,a.currentMonth,a.currentDay):new Date(9999,9,9)),w=this._getMinMaxDate(a,"min"),F=this._getMinMaxDate(a,"max"),z=a.drawMonth-z,D=a.drawYear;0>z&&(z+=12,D--);if(F)for(b=this._daylightSavingAdjust(new Date(F.getFullYear(),F.getMonth()-H[0]*H[1]+1,F.getDate())),b=w&&b<w?w:b;this._daylightSavingAdjust(new Date(D,z,1))>
b;)z--,0>z&&(z=11,D--);a.drawMonth=z;a.drawYear=D;b=this._get(a,"prevText");b=g?this.formatDate(b,this._daylightSavingAdjust(new Date(D,z-e,1)),this._getFormatConfig(a)):b;b=this._canAdjustMonth(a,-1,D,z)?"<a class='ui-datepicker-prev ui-corner-all' data-handler='prev' data-event='click' title='"+b+"'><span class='ui-icon ui-icon-circle-triangle-"+(G?"e":"w")+"'>"+b+"</span></a>":d?"":"<a class='ui-datepicker-prev ui-corner-all ui-state-disabled' title='"+b+"'><span class='ui-icon ui-icon-circle-triangle-"+
(G?"e":"w")+"'>"+b+"</span></a>";c=this._get(a,"nextText");c=g?this.formatDate(c,this._daylightSavingAdjust(new Date(D,z+e,1)),this._getFormatConfig(a)):c;d=this._canAdjustMonth(a,1,D,z)?"<a class='ui-datepicker-next ui-corner-all' data-handler='next' data-event='click' title='"+c+"'><span class='ui-icon ui-icon-circle-triangle-"+(G?"w":"e")+"'>"+c+"</span></a>":d?"":"<a class='ui-datepicker-next ui-corner-all ui-state-disabled' title='"+c+"'><span class='ui-icon ui-icon-circle-triangle-"+(G?"w":
"e")+"'>"+c+"</span></a>";e=this._get(a,"currentText");c=this._get(a,"gotoCurrent")&&a.currentDay?N:A;e=g?this.formatDate(e,c,this._getFormatConfig(a)):e;g=a.inline?"":"<button type='button' class='ui-datepicker-close ui-state-default ui-priority-primary ui-corner-all' data-handler='hide' data-event='click'>"+this._get(a,"closeText")+"</button>";h=h?"<div class='ui-datepicker-buttonpane ui-widget-content'>"+(G?g:"")+(this._isInRange(a,c)?"<button type='button' class='ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all' data-handler='today' data-event='click'>"+
e+"</button>":"")+(G?"":g)+"</div>":"";g=parseInt(this._get(a,"firstDay"),10);g=isNaN(g)?0:g;e=this._get(a,"showWeek");c=this._get(a,"dayNames");k=this._get(a,"dayNamesMin");l=this._get(a,"monthNames");m=this._get(a,"monthNamesShort");n=this._get(a,"beforeShowDay");p=this._get(a,"showOtherMonths");s=this._get(a,"selectOtherMonths");t=this._getDefaultDate(a);q="";r;for(u=0;u<H[0];u++){E="";this.maxRows=4;for(v=0;v<H[1];v++){C=this._daylightSavingAdjust(new Date(D,z,a.selectedDay));r=" ui-corner-all";
x="";if(J){x+="<div class='ui-datepicker-group";if(1<H[1])switch(v){case 0:x+=" ui-datepicker-group-first";r=" ui-corner-"+(G?"right":"left");break;case H[1]-1:x+=" ui-datepicker-group-last";r=" ui-corner-"+(G?"left":"right");break;default:x+=" ui-datepicker-group-middle",r=""}x+="'>"}x+="<div class='ui-datepicker-header ui-widget-header ui-helper-clearfix"+r+"'>"+(/all|left/.test(r)&&0===u?G?d:b:"")+(/all|right/.test(r)&&0===u?G?b:d:"")+this._generateMonthYearHeader(a,z,D,w,F,0<u||0<v,l,m)+"</div><table class='ui-datepicker-calendar'><thead><tr>";
B=e?"<th class='ui-datepicker-week-col'>"+this._get(a,"weekHeader")+"</th>":"";for(r=0;7>r;r++)y=(r+g)%7,B+="<th scope='col'"+(5<=(r+g+6)%7?" class='ui-datepicker-week-end'":"")+"><span title='"+c[y]+"'>"+k[y]+"</span></th>";x+=B+"</tr></thead><tbody>";B=this._getDaysInMonth(D,z);D===a.selectedYear&&z===a.selectedMonth&&(a.selectedDay=Math.min(a.selectedDay,B));r=(this._getFirstDayOfMonth(D,z)-g+7)%7;B=Math.ceil((r+B)/7);this.maxRows=B=J?this.maxRows>B?this.maxRows:B:B;y=this._daylightSavingAdjust(new Date(D,
z,1-r));for(I=0;I<B;I++){x+="<tr>";K=e?"<td class='ui-datepicker-week-col'>"+this._get(a,"calculateWeek")(y)+"</td>":"";for(r=0;7>r;r++)M=n?n.apply(a.input?a.input[0]:null,[y]):[!0,""],P=(L=y.getMonth()!==z)&&!s||!M[0]||w&&y<w||F&&y>F,K+="<td class='"+(5<=(r+g+6)%7?" ui-datepicker-week-end":"")+(L?" ui-datepicker-other-month":"")+(y.getTime()===C.getTime()&&z===a.selectedMonth&&a._keyEvent||t.getTime()===y.getTime()&&t.getTime()===C.getTime()?" "+this._dayOverClass:"")+(P?" "+this._unselectableClass+
" ui-state-disabled":"")+(L&&!p?"":" "+M[1]+(y.getTime()===N.getTime()?" "+this._currentClass:"")+(y.getTime()===A.getTime()?" ui-datepicker-today":""))+"'"+(L&&!p||!M[2]?"":" title='"+M[2].replace(/'/g,"&#39;")+"'")+(P?"":" data-handler='selectDay' data-event='click' data-month='"+y.getMonth()+"' data-year='"+y.getFullYear()+"'")+">"+(L&&!p?"&#xa0;":P?"<span class='ui-state-default'>"+y.getDate()+"</span>":"<a class='ui-state-default"+(y.getTime()===A.getTime()?" ui-state-highlight":"")+(y.getTime()===
N.getTime()?" ui-state-active":"")+(L?" ui-priority-secondary":"")+"' href='#'>"+y.getDate()+"</a>")+"</td>",y.setDate(y.getDate()+1),y=this._daylightSavingAdjust(y);x+=K+"</tr>"}z++;11<z&&(z=0,D++);x+="</tbody></table>"+(J?"</div>"+(0<H[0]&&v===H[1]-1?"<div class='ui-datepicker-row-break'></div>":""):"");E+=x}q+=E}a._keyEvent=!1;return q+h},_generateMonthYearHeader:function(a,b,c,d,e,g,h,k){var l,m,n,p=this._get(a,"changeMonth"),s=this._get(a,"changeYear"),t=this._get(a,"showMonthAfterYear"),q="<div class='ui-datepicker-title'>",
r="";if(g||!p)r+="<span class='ui-datepicker-month'>"+h[b]+"</span>";else{h=d&&d.getFullYear()===c;l=e&&e.getFullYear()===c;r+="<select class='ui-datepicker-month' data-handler='selectMonth' data-event='change'>";for(m=0;12>m;m++)(!h||m>=d.getMonth())&&(!l||m<=e.getMonth())&&(r+="<option value='"+m+"'"+(m===b?" selected='selected'":"")+">"+k[m]+"</option>");r+="</select>"}t||(q+=r+(!g&&p&&s?"":"&#xa0;"));if(!a.yearshtml)if(a.yearshtml="",g||!s)q+="<span class='ui-datepicker-year'>"+c+"</span>";else{k=
...
a.yearshtml+="</select>";q+=a.yearshtml;a.yearshtml=null}q+=this._get(a,"yearSuffix");t&&(q+=(!g&&p&&s?"":"&#xa0;")+r);return q+"</div>"},_adjustInstDate:function(a,b,c){var d=a.drawYear+("Y"===c?b:0),e=a.drawMonth+("M"===c?b:0);b=Math.min(a.selectedDay,this._getDaysInMonth(d,e))+("D"===c?b:0);d=this._restrictMinMax(a,this._daylightSavingAdjust(new Date(d,e,b)));a.selectedDay=d.getDate();a.drawMonth=a.selectedMonth=d.getMonth();a.drawYear=a.selectedYear=d.getFullYear();"M"!==c&&"Y"!==c||this._notifyChange(a)},
...
0)},_processTabs:function(){var a=this;this.tablist=this._getList().addClass("ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all").attr("role","tablist");this.tabs=this.tablist.find("> li:has(a[href])").addClass("ui-state-default ui-corner-top").attr({role:"tab",tabIndex:-1});this.anchors=this.tabs.map(function(){return d("a",this)[0]}).addClass("ui-tabs-anchor").attr({role:"presentation",tabIndex:-1});this.panels=d();this.anchors.each(function(b,c){var f,e,g=d(c).uniqueId().attr("id"),
...
this.options,c=this.active,f=d(a.currentTarget).closest("li"),e=f[0]===c[0],g=e&&b.collapsible,h=g?d():this._getPanelForTab(f),k=c.length?this._getPanelForTab(c):d(),c={oldTab:c,oldPanel:k,newTab:g?d():f,newPanel:h};a.preventDefault();f.hasClass("ui-state-disabled")||f.hasClass("ui-tabs-loading")||this.running||e&&!b.collapsible||!1===this._trigger("beforeActivate",a,c)||(b.active=g?!1:this.tabs.index(f),this.active=e?d():f,this.xhr&&this.xhr.abort(),k.length||h.length||d.error("jQuery UI Tabs: Mismatching fragment identifier."),
h.length&&this.load(this.tabs.index(f),a),this._toggle(a,c))},_toggle:function(a,b){function c(){e.running=!1;e._trigger("activate",a,b)}function f(){b.newTab.closest("li").addClass("ui-tabs-active ui-state-active");g.length&&e.options.show?e._show(g,e.options.show,c):(g.show(),c())}var e=this,g=b.newPanel,h=b.oldPanel;this.running=!0;h.length&&this.options.hide?this._hide(h,this.options.hide,function(){b.oldTab.closest("li").removeClass("ui-tabs-active ui-state-active");f()}):(b.oldTab.closest("li").removeClass("ui-tabs-active ui-state-active"),
...
if(-1!==d.inArray(a,b))return;b=d.isArray(b)?d.merge([a],b).sort():[a]}this._setupDisabled(b)}},load:function(a,b){a=this._getIndex(a);var c=this,f=this.tabs.eq(a),e=f.find(".ui-tabs-anchor"),g=this._getPanelForTab(f),h={tab:f,panel:g};this._isLocal(e[0])||(this.xhr=d.ajax(this._ajaxSettings(e,b,h)))&&"canceled"!==this.xhr.statusText&&(f.addClass("ui-tabs-loading"),g.attr("aria-busy","true"),this.xhr.success(function(a){setTimeout(function(){g.html(a);c._trigger("load",b,h)},1)}).complete(function(a,
b){setTimeout(function(){"abort"===b&&c.panels.stop(!1,!0);f.removeClass("ui-tabs-loading");g.removeAttr("aria-busy");a===c.xhr&&delete c.xhr},1)}))},_ajaxSettings:function(a,b,c){var f=this;return{url:a.attr("href"),beforeSend:function(a,g){return f._trigger("beforeLoad",b,d.extend({jqXHR:a,ajaxSettings:g},c))}}},_getPanelForTab:function(a){a=d(a).attr("aria-controls");return this.element.find(this._sanitizeSelector("#"+a))}});d.widget("ui.tooltip",{version:"1.11.0",options:{content:function(){var a=
...
g+120:60*(b-c)/g+240)%360,h,k,null==a?1:a]};l.hsla.from=function(a){if(null==a[0]||null==a[1]||null==a[2])return[null,null,null,a[3]];var b=a[0]/360,c=a[1],d=a[2];a=a[3];c=.5>=d?d*(1+c):d+c-d*c;d=2*d-c;return[Math.round(255*e(d,c,b+1/3)),Math.round(255*e(d,c,b)),Math.round(255*e(d,c,b-1/3)),a]};t(l,function(d,f){var e=f.props,h=f.cache,l=f.to,m=f.from;k.fn[d]=function(d){l&&!this[h]&&(this[h]=l(this._rgba));if(d===b)return this[h].slice();var f,g=a.type(d),n="array"===g||"object"===g?d:arguments,
p=this[h].slice();t(e,function(a,b){var d=n["object"===g?a:b.idx];null==d&&(d=p[b.idx]);p[b.idx]=c(d,b)});return m?(f=k(m(p)),f[h]=p,f):k(p)};t(e,function(b,c){k.fn[b]||(k.fn[b]=function(f){var e=a.type(f),h="alpha"===b?this._hsla?"hsla":"rgba":d,k=this[h](),l=k[c.idx];if("undefined"===e)return l;"function"===e&&(f=f.call(this,l),e=a.type(f));if(null==f&&c.empty)return this;"string"===e&&(e=g.exec(f))&&(f=l+parseFloat(e[2])*("+"===e[1]?1:-1));k[c.idx]=f;return this[h](k)})})});k.hook=function(b){b=
b.split(" ");t(b,function(b,c){a.cssHooks[c]={set:function(b,e){var g,h="";if("transparent"!==e&&("string"!==a.type(e)||(g=d(e)))){e=k(g||e);if(!n.rgba&&1!==e._rgba[3]){for(g="backgroundColor"===c?b.parentNode:b;(""===h||"transparent"===h)&&g&&g.style;)try{h=a.css(g,"backgroundColor"),g=g.parentNode}catch(l){}e=e.blend(h&&"transparent"!==h?h:"_default")}e=e.toRgbaString()}try{b.style[c]=e}catch(m){}}};a.fx.step[c]=function(b){b.colorInit||(b.start=k(b.elem,c),b.end=k(b.end),b.colorInit=!0);a.cssHooks[c].set(b.elem,
...
borderBottom:1,borderColor:1,borderLeft:1,borderRight:1,borderTop:1,borderWidth:1,margin:1,padding:1};d.each(["borderLeftStyle","borderRightStyle","borderBottomStyle","borderTopStyle"],function(a,b){d.fx.step[b]=function(a){if("none"!==a.end&&!a.setAttr||1===a.pos&&!a.setAttr)jQuery.style(a.elem,b,a.end),a.setAttr=!0}});d.fn.addBack||(d.fn.addBack=function(a){return this.add(null==a?this.prevObject:this.prevObject.filter(a))});d.effects.animateClass=function(f,e,g,h){var k=d.speed(e,g,h);return this.queue(function(){var e=
d(this),g=e.attr("class")||"",h,p=k.children?e.find("*").addBack():e,p=p.map(function(){return{el:d(this),start:a(this)}});h=function(){d.each(b,function(a,b){if(f[b])e[b+"Class"](f[b])})};h();p=p.map(function(){this.end=a(this.el[0]);var b=this.start,f=this.end,e={},g,h;for(g in f)h=f[g],b[g]===h||c[g]||!d.fx.step[g]&&isNaN(parseFloat(h))||(e[g]=h);this.diff=e;return this});e.attr("class",g);p=p.map(function(){var a=this,b=d.Deferred(),c=d.extend({},k,{queue:!1,complete:function(){b.resolve(a)}});
this.el.animate(this.diff,c);return b.promise()});d.when.apply(d,p.get()).done(function(){h();d.each(arguments,function(){var a=this.el;d.each(this.diff,function(b){a.css(b,"")})});k.complete.call(e[0])})})};d.fn.extend({addClass:function(a){return function(b,c,h,k){return c?d.effects.animateClass.call(this,{add:b},c,h,k):a.apply(this,arguments)}}(d.fn.addClass),removeClass:function(a){return function(b,c,h,k){return 1<arguments.length?d.effects.animateClass.call(this,{remove:b},c,h,k):a.apply(this,
...
e=null,b={});if("number"===typeof b||d.fx.speeds[b])g=e,e=b,b={};d.isFunction(e)&&(g=e,e=null);b&&d.extend(a,b);e=e||b.duration;a.duration=d.fx.off?0:"number"===typeof e?e:e in d.fx.speeds?d.fx.speeds[e]:d.fx.speeds._default;a.complete=g||b.complete;return a}function b(a){return!a||"number"===typeof a||d.fx.speeds[a]||"string"===typeof a&&!d.effects.effect[a]||d.isFunction(a)||"object"===typeof a&&!a.effect?!0:!1}d.extend(d.effects,{version:"1.11.0",save:function(a,b){for(var d=0;d<b.length;d++)null!==
b[d]&&a.data("ui-effects-"+b[d],a[0].style[b[d]])},restore:function(a,b){var d,g;for(g=0;g<b.length;g++)null!==b[g]&&(d=a.data("ui-effects-"+b[g]),void 0===d&&(d=""),a.css(b[g],d))},setMode:function(a,b){"toggle"===b&&(b=a.is(":hidden")?"show":"hide");return b},getBaseline:function(a,b){var d,g;switch(a[0]){case "top":d=0;break;case "middle":d=.5;break;case "bottom":d=1;break;default:d=a[0]/b.height}switch(a[1]){case "left":g=0;break;case "center":g=.5;break;case "right":g=1;break;default:g=a[1]/
b.width}return{x:g,y:d}},createWrapper:function(a){if(a.parent().is(".ui-effects-wrapper"))return a.parent();var b={width:a.outerWidth(!0),height:a.outerHeight(!0),"float":a.css("float")},e=d("<div></div>").addClass("ui-effects-wrapper").css({fontSize:"100%",background:"transparent",border:"none",margin:0,padding:0}),g={width:a.width(),height:a.height()},h=document.activeElement;try{h.id}catch(k){h=document.body}a.wrap(e);(a[0]===h||d.contains(a[0],h))&&d(h).focus();e=a.parent();"static"===a.css("position")?
(e.css({position:"relative"}),a.css({position:"relative"})):(d.extend(b,{position:a.css("position"),zIndex:a.css("z-index")}),d.each(["top","left","bottom","right"],function(d,e){b[e]=a.css(e);isNaN(parseInt(b[e],10))&&(b[e]="auto")}),a.css({position:"relative",top:0,left:0,right:"auto",bottom:"auto"}));a.css(g);return e.css(b).show()},removeWrapper:function(a){var b=document.activeElement;a.parent().is(".ui-effects-wrapper")&&(a.parent().replaceWith(a),(a[0]===b||d.contains(a[0],b))&&d(b).focus());
return a},setTransition:function(a,b,e,g){g=g||{};d.each(b,function(b,d){var f=a.cssUnit(d);0<f[0]&&(g[d]=f[0]*e+f[1])});return g}});d.fn.extend({effect:function(){function b(a){function c(){d.isFunction(g)&&g.call(e[0]);d.isFunction(a)&&a()}var e=d(this),g=f.complete,p=f.mode;(e.is(":hidden")?"hide"===p:"show"===p)?(e[p](),c()):h.call(e[0],f,c)}var f=a.apply(this,arguments),e=f.mode,g=f.queue,h=d.effects.effect[f.effect];return d.fx.off||!h?e?this[e](f.duration,f.complete):this.each(function(){f.complete&&
...
(a-1))*Math.sin((80*(a-1)-7.5)*Math.PI/15)},Back:function(a){return a*a*(3*a-2)},Bounce:function(a){for(var c,d=4;a<((c=Math.pow(2,--d))-1)/11;);return 1/Math.pow(4,3-d)-7.5625*Math.pow((3*c-2)/22-a,2)}});d.each(a,function(a,c){d.easing["easeIn"+a]=c;d.easing["easeOut"+a]=function(a){return 1-c(1-a)};d.easing["easeInOut"+a]=function(a){return.5>a?c(2*a)/2:1-c(-2*a+2)/2}})})();d.effects.effect.blind=function(a,b){var c=d(this),f="position top bottom left right height width".split(" "),e=d.effects.setMode(c,
a.mode||"hide"),g=a.direction||"up",h=/up|down|vertical/.test(g),k=h?"height":"width",l=h?"top":"left",g=/up|left|vertical|horizontal/.test(g),m={},n="show"===e,p,s,t;c.parent().is(".ui-effects-wrapper")?d.effects.save(c.parent(),f):d.effects.save(c,f);c.show();p=d.effects.createWrapper(c).css({overflow:"hidden"});s=p[k]();t=parseFloat(p.css(l))||0;m[k]=n?s:0;g||(c.css(h?"bottom":"right",0).css(h?"top":"left","auto").css({position:"absolute"}),m[l]=n?t:s+t);n&&(p.css(k,0),g||p.css(l,t+s));p.animate(m,
{duration:a.duration,easing:a.easing,queue:!1,complete:function(){"hide"===e&&c.hide();d.effects.restore(c,f);d.effects.removeWrapper(c);b()}})};d.effects.effect.bounce=function(a,b){var c=d(this),f="position top bottom left right height width".split(" "),e=d.effects.setMode(c,a.mode||"effect"),g="hide"===e,h="show"===e,k=a.direction||"up",e=a.distance,l=a.times||5,m=2*l+(h||g?1:0),n=a.duration/m,p=a.easing,s="up"===k||"down"===k?"top":"left",k="up"===k||"left"===k,t,q,r=c.queue(),u=r.length;(h||
g)&&f.push("opacity");d.effects.save(c,f);c.show();d.effects.createWrapper(c);e||(e=c["top"===s?"outerHeight":"outerWidth"]()/3);h&&(q={opacity:1},q[s]=0,c.css("opacity",0).css(s,k?2*-e:2*e).animate(q,n,p));g&&(e/=Math.pow(2,l-1));q={};for(h=q[s]=0;h<l;h++)t={},t[s]=(k?"-=":"+=")+e,c.animate(t,n,p).animate(q,n,p),e=g?2*e:e/2;g&&(t={opacity:0},t[s]=(k?"-=":"+=")+e,c.animate(t,n,p));c.queue(function(){g&&c.hide();d.effects.restore(c,f);d.effects.removeWrapper(c);b()});1<u&&r.splice.apply(r,[1,0].concat(r.splice(u,
m+1)));c.dequeue()};d.effects.effect.clip=function(a,b){var c=d(this),f="position top bottom left right height width".split(" "),e="show"===d.effects.setMode(c,a.mode||"hide"),g="vertical"===(a.direction||"vertical"),h=g?"height":"width",g=g?"top":"left",k={},l,m;d.effects.save(c,f);c.show();l=d.effects.createWrapper(c).css({overflow:"hidden"});l="IMG"===c[0].tagName?l:c;m=l[h]();e&&(l.css(h,0),l.css(g,m/2));k[h]=e?m:0;k[g]=e?0:m/2;l.animate(k,{queue:!1,duration:a.duration,easing:a.easing,complete:function(){e||
c.hide();d.effects.restore(c,f);d.effects.removeWrapper(c);b()}})};d.effects.effect.drop=function(a,b){var c=d(this),f="position top bottom left right opacity height width".split(" "),e=d.effects.setMode(c,a.mode||"hide"),g="show"===e,h=a.direction||"left",k="up"===h||"down"===h?"top":"left",h="up"===h||"left"===h?"pos":"neg",l={opacity:g?1:0},m;d.effects.save(c,f);c.show();d.effects.createWrapper(c);m=a.distance||c["top"===k?"outerHeight":"outerWidth"](!0)/2;g&&c.css("opacity",0).css(k,"pos"===h?
-m:m);l[k]=(g?"pos"===h?"+=":"-=":"pos"===h?"-=":"+=")+m;c.animate(l,{queue:!1,duration:a.duration,easing:a.easing,complete:function(){"hide"===e&&c.hide();d.effects.restore(c,f);d.effects.removeWrapper(c);b()}})};d.effects.effect.explode=function(a,b){function c(){n.push(this);n.length===f*e&&(g.css({visibility:"visible"}),d(n).remove(),h||g.hide(),b())}var f=a.pieces?Math.round(Math.sqrt(a.pieces)):3,e=f,g=d(this),h="show"===d.effects.setMode(g,a.mode||"hide"),k=g.show().css("visibility","hidden").offset(),
l=Math.ceil(g.outerWidth()/e),m=Math.ceil(g.outerHeight()/f),n=[],p,s,t,q,r,u;for(p=0;p<f;p++)for(q=k.top+p*m,u=p-(f-1)/2,s=0;s<e;s++)t=k.left+s*l,r=s-(e-1)/2,g.clone().appendTo("body").wrap("<div></div>").css({position:"absolute",visibility:"visible",left:-s*l,top:-p*m}).parent().addClass("ui-effects-explode").css({position:"absolute",overflow:"hidden",width:l,height:m,left:t+(h?r*l:0),top:q+(h?u*m:0),opacity:h?0:1}).animate({left:t+(h?0:r*l),top:q+(h?0:u*m),opacity:h?1:0},a.duration||500,a.easing,
c)};d.effects.effect.fade=function(a,b){var c=d(this),f=d.effects.setMode(c,a.mode||"toggle");c.animate({opacity:f},{queue:!1,duration:a.duration,easing:a.easing,complete:b})};d.effects.effect.fold=function(a,b){var c=d(this),f="position top bottom left right height width".split(" "),e=d.effects.setMode(c,a.mode||"hide"),g="show"===e,h="hide"===e,e=a.size||15,k=/([0-9]+)%/.exec(e),l=!!a.horizFirst,m=g!==l,n=m?["width","height"]:["height","width"],p=a.duration/2,s,t={},q={};d.effects.save(c,f);c.show();
s=d.effects.createWrapper(c).css({overflow:"hidden"});m=m?[s.width(),s.height()]:[s.height(),s.width()];k&&(e=parseInt(k[1],10)/100*m[h?0:1]);g&&s.css(l?{height:0,width:e}:{height:e,width:0});t[n[0]]=g?m[0]:e;q[n[1]]=g?m[1]:0;s.animate(t,p,a.easing).animate(q,p,a.easing,function(){h&&c.hide();d.effects.restore(c,f);d.effects.removeWrapper(c);b()})};d.effects.effect.highlight=function(a,b){var c=d(this),f=["backgroundImage","backgroundColor","opacity"],e=d.effects.setMode(c,a.mode||"show"),g={backgroundColor:c.css("backgroundColor")};
"hide"===e&&(g.opacity=0);d.effects.save(c,f);c.show().css({backgroundImage:"none",backgroundColor:a.color||"#ffff99"}).animate(g,{queue:!1,duration:a.duration,easing:a.easing,complete:function(){"hide"===e&&c.hide();d.effects.restore(c,f);b()}})};d.effects.effect.size=function(a,b){var c,f,e,g,h,k,l=d(this),m="position top bottom left right width height overflow opacity".split(" ");h="position top bottom left right overflow opacity".split(" ");var n=["width","height","overflow"],p=["fontSize"],s=
["borderTopWidth","borderBottomWidth","paddingTop","paddingBottom"],t=["borderLeftWidth","borderRightWidth","paddingLeft","paddingRight"],q=d.effects.setMode(l,a.mode||"effect"),r=a.restore||"effect"!==q,u=a.scale||"both";k=a.origin||["middle","center"];var A=l.css("position"),v=r?m:h,C={height:0,width:0,outerHeight:0,outerWidth:0};"show"===q&&l.show();h={height:l.height(),width:l.width(),outerHeight:l.outerHeight(),outerWidth:l.outerWidth()};"toggle"===a.mode&&"show"===q?(l.from=a.to||C,l.to=a.from||
h):(l.from=a.from||("show"===q?C:h),l.to=a.to||("hide"===q?C:h));e=l.from.height/h.height;g=l.from.width/h.width;c=l.to.height/h.height;f=l.to.width/h.width;if("box"===u||"both"===u)e!==c&&(v=v.concat(s),l.from=d.effects.setTransition(l,s,e,l.from),l.to=d.effects.setTransition(l,s,c,l.to)),g!==f&&(v=v.concat(t),l.from=d.effects.setTransition(l,t,g,l.from),l.to=d.effects.setTransition(l,t,f,l.to));"content"!==u&&"both"!==u||e===c||(v=v.concat(p).concat(n),l.from=d.effects.setTransition(l,p,e,l.from),
l.to=d.effects.setTransition(l,p,c,l.to));d.effects.save(l,v);l.show();d.effects.createWrapper(l);l.css("overflow","hidden").css(l.from);k&&(k=d.effects.getBaseline(k,h),l.from.top=(h.outerHeight-l.outerHeight())*k.y,l.from.left=(h.outerWidth-l.outerWidth())*k.x,l.to.top=(h.outerHeight-l.to.outerHeight)*k.y,l.to.left=(h.outerWidth-l.to.outerWidth)*k.x);l.css(l.from);if("content"===u||"both"===u)s=s.concat(["marginTop","marginBottom"]).concat(p),t=t.concat(["marginLeft","marginRight"]),n=m.concat(s).concat(t),
l.find("*[width]").each(function(){var b=d(this),h=b.height(),k=b.width(),l=b.outerHeight(),m=b.outerWidth();r&&d.effects.save(b,n);b.from={height:h*e,width:k*g,outerHeight:l*e,outerWidth:m*g};b.to={height:h*c,width:k*f,outerHeight:h*c,outerWidth:k*f};e!==c&&(b.from=d.effects.setTransition(b,s,e,b.from),b.to=d.effects.setTransition(b,s,c,b.to));g!==f&&(b.from=d.effects.setTransition(b,t,g,b.from),b.to=d.effects.setTransition(b,t,f,b.to));b.css(b.from);b.animate(b.to,a.duration,a.easing,function(){r&&
d.effects.restore(b,n)})});l.animate(l.to,{queue:!1,duration:a.duration,easing:a.easing,complete:function(){0===l.to.opacity&&l.css("opacity",l.from.opacity);"hide"===q&&l.hide();d.effects.restore(l,v);r||("static"===A?l.css({position:"relative",top:l.to.top,left:l.to.left}):d.each(["top","left"],function(a,b){l.css(b,function(b,c){var d=parseInt(c,10),e=a?l.to.left:l.to.top;return"auto"===c?e+"px":d+e+"px"})}));d.effects.removeWrapper(l);b()}})};d.effects.effect.scale=function(a,b){var c=d(this),
f=d.extend(!0,{},a),e=d.effects.setMode(c,a.mode||"effect"),g=parseInt(a.percent,10)||(0===parseInt(a.percent,10)?0:"hide"===e?0:100),h=a.direction||"both",k=a.origin,l={height:c.height(),width:c.width(),outerHeight:c.outerHeight(),outerWidth:c.outerWidth()},m="horizontal"!==h?g/100:1,g="vertical"!==h?g/100:1;f.effect="size";f.queue=!1;f.complete=b;"effect"!==e&&(f.origin=k||["middle","center"],f.restore=!0);f.from=a.from||("show"===e?{height:0,width:0,outerHeight:0,outerWidth:0}:l);f.to={height:l.height*
m,width:l.width*g,outerHeight:l.outerHeight*m,outerWidth:l.outerWidth*g};f.fade&&("show"===e&&(f.from.opacity=0,f.to.opacity=1),"hide"===e&&(f.from.opacity=1,f.to.opacity=0));c.effect(f)};d.effects.effect.puff=function(a,b){var c=d(this),f=d.effects.setMode(c,a.mode||"hide"),e="hide"===f,g=parseInt(a.percent,10)||150,h=g/100,k={height:c.height(),width:c.width(),outerHeight:c.outerHeight(),outerWidth:c.outerWidth()};d.extend(a,{effect:"scale",queue:!1,fade:!0,mode:f,complete:b,percent:e?g:100,from:e?
...
[1,0].concat(l.splice(m,f+1)));c.dequeue()};d.effects.effect.shake=function(a,b){var c=d(this),f="position top bottom left right height width".split(" "),e=d.effects.setMode(c,a.mode||"effect"),g=a.direction||"left",h=a.distance||20,k=a.times||3,l=2*k+1,m=Math.round(a.duration/l),n="up"===g||"down"===g?"top":"left",p="up"===g||"left"===g,g={},s={},t={},q=c.queue(),r=q.length;d.effects.save(c,f);c.show();d.effects.createWrapper(c);g[n]=(p?"-=":"+=")+h;s[n]=(p?"+=":"-=")+2*h;t[n]=(p?"-=":"+=")+2*h;
c.animate(g,m,a.easing);for(h=1;h<k;h++)c.animate(s,m,a.easing).animate(t,m,a.easing);c.animate(s,m,a.easing).animate(g,m/2,a.easing).queue(function(){"hide"===e&&c.hide();d.effects.restore(c,f);d.effects.removeWrapper(c);b()});1<r&&q.splice.apply(q,[1,0].concat(q.splice(r,l+1)));c.dequeue()};d.effects.effect.slide=function(a,b){var c=d(this),f="position top bottom left right width height".split(" "),e=d.effects.setMode(c,a.mode||"show"),g="show"===e,h=a.direction||"left",k="up"===h||"down"===h?"top":
"left",h="up"===h||"left"===h,l,m={};d.effects.save(c,f);c.show();l=a.distance||c["top"===k?"outerHeight":"outerWidth"](!0);d.effects.createWrapper(c).css({overflow:"hidden"});g&&c.css(k,h?isNaN(l)?"-"+l:-l:l);m[k]=(g?h?"+=":"-=":h?"-=":"+=")+l;c.animate(m,{queue:!1,duration:a.duration,easing:a.easing,complete:function(){"hide"===e&&c.hide();d.effects.restore(c,f);d.effects.removeWrapper(c);b()}})};d.effects.effect.transfer=function(a,b){var c=d(this),f=d(a.to),e="fixed"===f.css("position"),g=d("body"),
