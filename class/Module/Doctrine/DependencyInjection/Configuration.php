                    ...
                    ->children()
                        ->arrayNode('metadata')
                            ...
                            ->children()
                                ...
                                ->scalarNode('path')->defaultValue('%kernel.cache_dir%/dbal/metadata')->end()
                            ->end()
                        ->end()
                        ->arrayNode('query')
                            ->addDefaultsIfNotSet()
                            ->children()
                                ->enumNode('type')->values(['redis','array','filesystem','memcached'])->defaultValue('array')->end()
                                ->scalarNode('path')->defaultValue('%kernel.cache_dir%/dbal/query')->end()
                            ->end()
                        ->end()
                        ->arrayNode('result')
                            ->addDefaultsIfNotSet()
                            ->children()
                                ->enumNode('type')->values(['redis','array','filesystem','memcached'])->defaultValue('array')->end()
                                ->scalarNode('path')->defaultValue('%kernel.cache_dir%/dbal/result')->end()
                            ->end()
                        ->end()
                    ->end()
                ->end()
