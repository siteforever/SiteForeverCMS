...
class Data_Table_GalleryCategory extends Data_Table
{
    ...
    protected function doGetFields()
    {
        return array(
            ...
            new Data_Field_Tinyint( 'middle_method', 4, false, 1 ),
            new Data_Field_Int( 'middle_width', 11, false, 200 ),
            new Data_Field_Int( 'middle_height', 11, false, 200 ),
            new Data_Field_Tinyint( 'thumb_method', 4, false, 1 ),
            new Data_Field_Int( 'thumb_width', 11, false, 100 ),
            new Data_Field_Int( 'thumb_height', 11, false, 100 ),
