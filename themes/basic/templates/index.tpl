...
<head>
    {style file="@root:static/system/jquery/fancybox/jquery.fancybox-1.3.1.css" filters='cssrewrite,?yui_css' output="static/fancybox.css"}
...
{js file="@root:static/system/jquery/fancybox/jquery.fancybox-1.3.1.js,@theme:js/script.js" filters='?yui_js'  output="static/site.js"}
</body>
</html>
